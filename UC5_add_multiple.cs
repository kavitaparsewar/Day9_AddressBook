...
namespace Day9_AddressBook
{
    class UC5_add_multiple
    {
        ...
        public static List<UC5_add_multiple> People = new List<UC5_add_multiple>();

        public static void NewContact()
        {
            UC5_add_multiple person = new UC5_add_multiple();
        ...
        public static void PrintDetails(UC5_add_multiple person)
        {
